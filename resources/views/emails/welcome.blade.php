                            ...
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->
                                        <h2>Welcome to Union Saver Trust Bank Corporation</h2>
                                        <br>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Thanks for joining Union Saver Trust Bank Corporation as your new home. We're excited to have you on board!
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                          Account Details:
                                        </p>
                                        ...
                                        <p style='line-height: 24px'>
                                            Kind Regards,</br>
                                            Union Saver Trust Bank Corporation
                                        </p>
