...
<head>
    <meta charset="utf-8" />
    <title>Union Saver Trust Bank Corporation | CREATE ACCOUNT</title>
...
<script src="//code.tidio.co/jykboldyyttgdyylkgq1lrs6hbfay1sg.js" async></script>
<div class="account-pages my-5 pt-sm-5">
 ...
 <option value='Afghanistan'>Afghanistan (؋)</option>
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the Union Saver Trust Bank Corporation <a href="#" class="text-primary">Terms of Use</a></p>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>©
                            ...
                            </script> Powered by <i class="bx bx-check-shield text-success"></i> by Union Saver Trust Bank Corporation</p>
                    </div>
                </div>
...
<div class="position-fixed top-0 end-0 p-2" style="z-index: 1005">
    <div id="ErrorToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="https://Union Saver Trust Bank Corporation.com/user/logo.png" alt="" class="me-2" height="18">
