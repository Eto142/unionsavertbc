                            ...
                            <div class="row clearfix">
                                ...
                                <div class="content-column col-lg-7 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        <h1> <span>Daily Life's Finances <br> <span style="color: #FF573D">Re-imagined</span></span> <span>For All</span> </h1>
                                        <div class="text" style="color:#1F1B44;">Union Saver Trust Bank Corporation continues to simplify and improve the financal aspect of todays world bit by bit through modern technologies and community involvment.</div>
                                        <div class="btn-box" >
                                            <a  href="{{route('register')}}" class="theme-btn btn-style-one rounded"><span class="txt">Open Account Now</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-column col-lg-6 col-md-12 col-sm-12 mb-0">
                                <div class="about-column">
                                    <div class="sec-title">
                                        ...
                                        <h2> <span style="color: #FF573D">Union Saver Trust Bank Corporation</span> <br></h2>
                                    </div>
                                    <div class="text">
                                        <p>
                                            Union Saver Trust Bank Corporation We kept our promise and expanded our reach, improving our technology thereby performing faster and safer transactions lightening fast.
                                        </p>
                                    </div>
                                            ...
                                            <div class="image">
                                                ...
                                                <div class="overlay-box">
                                                    <div class="overlay-inner">
                                                        <h3><a>Union Saver Trust Bank Corporation</a></h3>
                        ...
                        <div class="form-column col-lg-5 col-md-12 col-sm-12">
                            <div class="inner-column">
                                <div class="form-boxed">
                                    <!-- <h5>Our Values</h5> -->
                                    <div class="text">The mission of Union Saver Trust Bank Corporation is to go beyond what was deemed impossible and to  contribute to the sustainable development of the international banking sector by
                                        ...
                                        <div class="clearfix row g-0">
                                            ...
                                            <div class="content-column col-lg-6 col-md-6 col-sm-12 order-lg-1 order-2">
                                                <div class="inner-column">
                                                    ...
                                                    <div class="post-date">March 6th, 2003 by <span>Admin</span></div>
                                                </div>
                                            </div>
                                            <!-- Image Column -->
